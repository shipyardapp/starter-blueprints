...
def create_fallback_destination_file_name(source_file_name,destination_file_format):
    ...
    file_name = file_name.replace('.csv',f'{format_extensions[destination_file_format]}')
    return file_name
...
def main():
    ...
    if destination_file_name is None:
            destination_file_name = create_fallback_destination_file_name(source_file_name,destination_file_format)
    ...
    if destination_file_format == 'xlsx':
        ...
        input_df.to_excel(destination_full_path,engine='xlsxwriter',**extra_args)
